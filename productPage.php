...
<div class="container-fluid">
  <div class="row">
    <div class="col col-sm-4 bg-success">
      <div class="card" style="width:400px;">
        <img class="card-img-top" src="https://www.windowscentral.com/sites/wpcentral.com/files/styles/xlarge_wm_brb/public/field/image/2021/01/hp-spectre-x360-14-hero3.jpg" alt="Card image" style="width:100%">
        <div class="card-body">
    ...
    <div class="col col-sm-4 bg-warning">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="https://www.windowscentral.com/sites/wpcentral.com/files/styles/xlarge_wm_brb/public/field/image/2021/01/hp-spectre-x360-14-hero3.jpg" alt="Card image" style="width:100%">
        <div class="card-body">
        <h4 class="card-title">Product Title:</h4>
...
<div class="card">
  <img src="https://www.windowscentral.com/sites/wpcentral.com/files/styles/xlarge_wm_brb/public/field/image/2021/01/hp-spectre-x360-14-hero3.jpg" alt="Denim Jeans" style="width:100%; height:400px;">
  <h1>Laptop</h1>
  <p class="price">Rs 50000</p>
  <p>Some text about the Laptop. Super slim and comfy lorem ipsum lorem jeansum. Lorem jeamsun denim lorem jeansum.</p>
